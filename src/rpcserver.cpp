...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Giga features */
        {"Giga", "masternode", &masternode, true, true, false},
        {"Giga", "listmasternodes", &listmasternodes, true, true, false},
        {"Giga", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Giga", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Giga", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Giga", "masternodedebug", &masternodedebug, true, true, false},
        {"Giga", "startmasternode", &startmasternode, true, true, false},
        {"Giga", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Giga", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Giga", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Giga", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Giga", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Giga", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Giga", "mnbudget", &mnbudget, true, true, false},
        {"Giga", "preparebudget", &preparebudget, true, true, false},
        {"Giga", "submitbudget", &submitbudget, true, true, false},
        {"Giga", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Giga", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Giga", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Giga", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Giga", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Giga", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Giga", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Giga", "checkbudgets", &checkbudgets, true, true, false},
        {"Giga", "mnsync", &mnsync, true, true, false},
        {"Giga", "spork", &spork, true, true, false},
        {"Giga", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Giga", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Gigad, or the -server option to Giga-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Giga-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8349/\n";
}
