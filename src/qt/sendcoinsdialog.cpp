...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach (const SendCoinsRecipient& rcp, recipients) {
        ...
        // generate moGigapace address string
        QString address = "<span style='font-family: moGigapace;'>" + rcp.address;
        address.append("</span>");
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Giga address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
