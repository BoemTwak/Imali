...
/** Utility functions used by the Giga Qt UI.
 */
namespace GUIUtil
{
...
// Render Giga addresses in moGigapace font
...
// Parse "Giga:" URI into recipient object, return true on successful parsing
