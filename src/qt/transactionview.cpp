                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Giga from zGiga"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGiga"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGiga));
