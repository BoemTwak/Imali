                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Giga Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Giga address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Giga: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Giga Core"), this);
    aboutAction->setStatusTip(tr("Show information about Giga Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Giga"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Giga addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Giga addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagGigatic information"));
    ...
    openAction->setStatusTip(tr("Open a Giga: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Giga Core help message to get a list with possible Giga command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Giga Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Giga network", "", count));
}
...
{
    QString strTitle = tr("Giga Core"); // default title
...
/** Creates context menu, its actions, and Gigas up all the relevant signals for mouse events. */
