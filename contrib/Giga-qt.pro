...
RESOURCES += src/qt/Giga.qrc src/qt/Giga_locale.qrc

TRANSLATIONS += src/qt/locale/Giga_bg.ts \
                src/qt/locale/Giga_de.ts \
                src/qt/locale/Giga_en.ts \
                src/qt/locale/Giga_es.ts \
                src/qt/locale/Giga_fi.ts \
                src/qt/locale/Giga_fr.ts \
                src/qt/locale/Giga_it.ts \
                src/qt/locale/Giga_ja.ts \
                src/qt/locale/Giga_pl.ts \
                src/qt/locale/Giga_pt.ts \
                src/qt/locale/Giga_ru.ts \
                src/qt/locale/Giga_sk.ts \
                src/qt/locale/Giga_sv.ts \
                src/qt/locale/Giga_vi.ts \
                src/qt/locale/Giga_zh_CN.ts \
                src/qt/locale/Giga_zh_TW.ts
