...
In order to support loading of multiple wallets in Giga-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Giga.cpp.
...
Changes to Giga.cpp
----------------------
Giga.cpp is the entry point into Giga-qt, and as such, will require some minor modifications to provide hooks for
