Contributing to Giga Core
============================

The Giga Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Giga Core project, and is not to be
confused with overall Giga Network Protocol consensus changes.

Whether a pull request is merged into Giga Core rests with the project merge
...
Patches that change Giga consensus rules are considerably more involved than
...
Where a patch set proposes to change the Giga consensus, it must have been
...
The project leader is the release manager for each Giga Core release.
